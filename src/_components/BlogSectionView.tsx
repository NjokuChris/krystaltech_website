...
import BlogComp, { type BlogCardPost } from "./BlogComp";

/**
 * Presentational client child of BlogSection. Header row with a
 * "read all" link, then the three most recent posts in a clean grid.
 */
...
export default function BlogSectionView({ posts }: { posts: BlogCardPost[] }) {
