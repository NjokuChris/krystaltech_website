 ...
 *   - "Programs" opens a dropdown of the eight tracks (hover on
 *     desktop, tap-to-expand on mobile). Items come from PROGRAM_NAV
 *     so adding a program updates the menu automatically.
