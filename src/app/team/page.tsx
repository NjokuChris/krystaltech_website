...
/**
 * Team - Krystal Tech Hub
 * ------------------------------------------------------------
 * Meets the people behind the hub, in the site design system:
 *   - #F3F1EA sand, #11142B ink, #FFB627 amber
 *   - Founder feature, a grid of mentors/builders, and the values strip
 *   - Real photos from /public, framer-motion, rounded cards
 *
 * NOTE: names, roles and photos below are placeholders wired to the
 * images available in /public. Swap them for the real team when ready.
 */
...
const TEAM: Member[] = [
  {
    ...
    role: "Design Lead",
    image: "/our-man.jpg",
    bio: "Leads brand and product design across studio projects and teaches the Graphics and UI/UX tracks.",
  },
  {
    name: "David Eze",
    role: "Lead Developer",
    image: "/software-developer.jpg",
    bio: "Ships the web and mobile builds, and mentors the Web Development cohort from first line of HTML to deploy.",
  },
  {
    name: "Tunde Bello",
    role: "Robotics & AI Mentor",
    image: "/man.jpg",
    bio: "Runs the Robotics and Intro to AI tracks, turning sensors, motors and code into things that move and respond.",
  },
];
      ...
      <section className="px-5 pb-10 pt-16 md:px-10 md:pb-14 md:pt-24">
        <div className="mx-auto max-w-[1400px]">
          ...
          >
            Builders who
            <br />
            <span className="font-semibold">teach what they ship.</span>
          </motion.h1>
          <motion.p
            {...fadeUp}
          ...
          >
            The same team that builds websites, apps and brands for paying
            clients is the team in the classroom. Here&apos;s who you&apos;ll be
        ...
        <div className="mx-auto max-w-[1400px]">
          ...
          >
            ...
            <p className="max-w-sm text-sm text-[#11142B]/55">
              A small team by design - so every learner is known by name and
              every project gets real attention.
            </p>
          </motion.div>
        ...
        >
          <div>
            ...
            <p className="mt-3 max-w-lg text-[#11142B]/65">
              We&apos;re always glad to meet mentors and builders who care about
              the work. Reach out and tell us what you do.
            </p>
          </div>
          <Link
            href="/contact"
